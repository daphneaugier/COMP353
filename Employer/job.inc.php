...
function jobCreation(){
    ...
    <br> 
    <label for="ORGANISATION_NAME">Organisation Name</label><input type="text" name="ORGANISATION_NAME" id="ORGANISATION_NAME" />
    <br> 
    <label for="DESCRIPTION">Description</label><textarea name="DESCRIPTION" id="DESCRIPTION" cols="45" rows="5"></textarea>
    <br> 
    <label for="VACANCY">Vacancy</label><input type="text" name="VACANCY" id="VACANCY" />
    <br> 
